...
graphic_series <- c("LNS11300000","LNS11300001","LNS11300002","LNS11300003","LNS11300006","LNS11300009","LNS11300036","LNS11300060",
                    "LNS11300089","LNS11300091","LNS11300093","LNS11327659","LNS11327660","LNS11327662","LNS11327689","LNS11300004",
                    "LNS11300005","LNS11300007","LNS11324230", "LNS11300008", "LNS11300012")
...
Full_Title <- paste("Labor Force Participation Rates as a Proportion of Pre-Pandemic Level")

ggplot(lfp) +
  geom_segment( aes(x=g2_series_title, xend=g2_series_title, y=value_1m, yend=1), color="grey") +
  ...
  labs(x="",y="", subtitle=Full_Title, title="Where Labor Force Participation is Lagging") +
  ...
  geom_text(aes(x=g2_series_title, y=display_value, label=(round(display_value, 3))), size=6, nudge_y = -0.002, color = "#01579B") +
  theme(plot.caption = element_text(size=14, margin=margin(19,0,11,0)))
ggsave("graphics/LFP_lag.png", width = 19, height=10.68, dpi="retina")

...
##### TITLES #####
title1 <- "Unemployment Continues to Creep Up"
...
unrate <- get_n_series_table(
  c("LNS13000000","LNS11000000","CES0500000021","CES0000000001", "CES0000000010"),
  api_key = bls_get_key(),
  start_year = 2011,
  end_year = 2025,
  tidy = TRUE
...
ggsave("graphics/jobs_gained_fixed.png", dpi = "retina", width = 12, height = 6.75, units = "in")
